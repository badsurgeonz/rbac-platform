...
CREATE TABLE sys_permission (id BIGINT PRIMARY KEY AUTO_INCREMENT, code VARCHAR(128) UNIQUE NOT NULL, name VARCHAR(128) NOT NULL, type VARCHAR(16) NOT NULL, resource VARCHAR(255), action VARCHAR(32));
